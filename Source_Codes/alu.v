...
----------------------------------------------------------------------*/
module alu(
           input [31:0] RD1E,SrcBE,  // ALU 32-bit Inputs
    ...
    assign tmp = {1'b0,RD1E} + {1'b0,SrcBE};
    assign CarryOut = tmp[32]; // Carryout flag
	//assign Zero = (ALU_Result == 0);  // Zero Flag ALU_Result
	always @(*)
	begin
	   case(funct3E)
	   3'b000: ZeroE <= RD1E == SrcBE; //beq
	   3'b001: ZeroE <=  RD1E != SrcBE; //bne
	   3'b100: ZeroE <=  RD1E < SrcBE; //blt
	   3'b101: ZeroE <=  RD1E > SrcBE; //bge
	   3'b110: ZeroE <=  RD1E < SrcBE; //bltu
	   3'b111: ZeroE <=  RD1E >= SrcBE; //bgeu
	   default : ZeroE <= 0;
	   endcase
	end
    always @(*)
    begin
        case(ALUControlE)
        5'b00000: ALU_Result = RD1E + SrcBE ;
        5'b00001:  ALU_Result = RD1E - SrcBE ;
        5'b00010: // Multiplication
           ALU_Result = RD1E * SrcBE;
        5'b00011: // Division
           ALU_Result = RD1E/SrcBE;
        5'b00100: // Logical shift left
         ...
         5'b00110: // Rotate left
           ALU_Result = {RD1E[30:0],RD1E[31]};
         5'b00111: // Rotate right
           ALU_Result = {RD1E[0],RD1E[31:1]};
          ...
          5'b01110: // Greater comparison
           ALU_Result = (RD1E>SrcBE)?32'd1:32'd0 ;
          5'b01111: // Equal comparison
            ALU_Result = (RD1E==SrcBE)?32'd1:32'd0 ;
          5'b10000:
            ALU_Result =   SrcBE;
          default: ALU_Result = RD1E + SrcBE ;
        endcase
    end
